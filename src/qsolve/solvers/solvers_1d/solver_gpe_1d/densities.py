...
def compute_density_xy(self, identifier, kwargs):
    ...
    if identifier == "psi_tof_gpe":
        ...
        density_xy = qsolve_core_gpe_1d.compute_density_xy(self.psi_tof_free_gpe, index_z, rescaling)
        ...
        density_xy = qsolve_core_gpe_1d.compute_density_xy(self.psi_f_tof_free_schroedinger, index_z, rescaling)
...
def compute_density_xz(self, identifier, kwargs):
    ...
    if identifier == "psi_tof_gpe":
        ...
        density_xz = qsolve_core_gpe_1d.compute_density_xz(self.psi_tof_free_gpe, index_y, rescaling)
        ...
        density_xz = qsolve_core_gpe_1d.compute_density_xz(self.psi_f_tof_free_schroedinger, index_y, rescaling)

...
def compute_E_interaction(self, identifier, kwargs):
    ...
    if identifier == "psi":
        ...
        E_interaction = qsolve_core_gpe_1d.compute_interaction_energy(
            self.psi,
            self.dx,
            self.g)
...
def compute_E_kinetic(self, identifier, kwargs):
    ...
    if identifier == "psi":
        ...
        E_kinetic = qsolve_core_gpe_1d.compute_kinetic_energy(
            self.psi,
            self.dx,
            self.hbar,
            self.m_atom)
...
def compute_E_potential(self, identifier, kwargs):
    ...
    if identifier == "psi":
        ...
        E_potential = qsolve_core_gpe_1d.compute_potential_energy(self.psi, self.V, self.dx)

    elif identifier == "psi_0":

        E_potential = qsolve_core_gpe_1d.compute_potential_energy(self.psi_0, self.V, self.dx)
...
def compute_E_total(self, identifier, kwargs):
    ...
    if identifier == "psi":
        ...
        E = qsolve_core_gpe_1d.compute_total_energy(self.psi, self.V, self.dx, self.hbar, self.m_atom, self.g)

    elif identifier == "psi_0":

        E = qsolve_core_gpe_1d.compute_total_energy(self.psi_0, self.V, self.dx, self.hbar, self.m_atom, self.g)

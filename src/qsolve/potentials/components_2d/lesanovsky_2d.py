...
def eval_potential_lesanovsky_2d(x_2d, z_2d, g_F, m_F, m_F_prime, omega_perp, omega_para, omega_delta_detuning,
    ...
    # ---------------------------------------------------------------------------------------------
    B_static_x = B1 * x_2d - (B2 / 2) * x_2d * z_2d
    B_static_z = B0 + (B2 / 2) * (z_2d * z_2d - 0.5 * (x_2d * x_2d))

    norm_B_static = torch.sqrt(B_static_x * B_static_x + B_static_z * B_static_z)
    # ---------------------------------------------------------------------------------------------
    # =============================================================================================

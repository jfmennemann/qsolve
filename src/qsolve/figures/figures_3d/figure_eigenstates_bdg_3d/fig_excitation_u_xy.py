...
class FigExcitationUXY(object):

    def __init__(self, ax, V, excitations_u, nr, x, y, z, label_x, label_y, x_ticks, y_ticks, levels_V, cmap):
        ...
        u = np.squeeze(excitations_u[nr, :, :, index_z])
        ...
        title = r'$u_{' + '{0:d}'.format(nr+1) + '}(x, y, 0)$'

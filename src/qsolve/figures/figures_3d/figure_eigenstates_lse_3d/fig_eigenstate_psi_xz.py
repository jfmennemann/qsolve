...
class FigEigenstatePsiXZ(object):

    def __init__(self, ax, V, eigenstates, nr, x, y, z, label_x, label_z, x_ticks, z_ticks, levels_V, cmap):
        ...
        psi = np.squeeze(eigenstates[nr, :, index_y, :])
        ...
        title = r'$\psi_{' + '{0:d}'.format(nr) + '}(x, 0, z)$'

...
class FigEigenstatePsiXY(object):

    def __init__(self, ax, V, eigenstates, nr, x, y, z, label_x, label_y, x_ticks, y_ticks, levels_V, cmap):
        ...
        psi = np.squeeze(eigenstates[nr, :, :, index_z])
        ...
        title = r'$\psi_{' + '{0:d}'.format(nr) + '}(x, y, 0)$'

from qsolve.potentials.components_2d.lesanovsky_2d import eval_potential_lesanovsky_2d
...
class PotentialLesanovsky2D(object):
    ...
    def compute_external_potential(self, t, u):
        ...
        V_lesanovsky = eval_potential_lesanovsky_2d(
            self._x_2d,
            self._y_2d,
            self._g_F,
            self._m_F,
        ...
        V_tilt_x = -1.0 * u[1] * self._gamma_tilt_ref * self._x_2d
